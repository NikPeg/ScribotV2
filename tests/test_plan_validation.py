...
def test_count_plan_items_simple():
...
def test_count_plan_items_no_subsections():
...
def test_count_plan_items_empty():
...
def test_count_plan_items_many_subsections():
...
def test_validate_work_plan_valid():
...
def test_validate_work_plan_invalid():
...
def test_validate_work_plan_minimum_one():
...
def test_validate_work_plan_exact_threshold():
...
def test_validate_work_plan_invalid_text():
...
def test_validate_work_plan_empty():
...
def test_validate_work_plan_large_work():
...
def test_validate_work_plan_with_bibliography():
