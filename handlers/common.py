...
INFO_MESSAGE = (
    ...
    "Мы всегда рады вашим отзывам и предложениям. Если у вас возникнут вопросы, обращайтесь к администратору: @nikpeg.\n\n"
    ...
    "💬 <a href='https://t.me/scribot_feedback'>Канал с отзывами</a>\n\n"
